...
| --- | --- | --- | --- | --- | --- |
| example-skill | Personal | https://github.com/example/skill | 1.2.0 | 1.3.0 | Yes |
| custom-skill | Personal | https://github.com/example/custom-skill | 2.0.0 | 2.1.0 | Review required |
| system-skill | System | None | Unknown | Unknown | Managed by Codex |

An unregistered Skill without a verified GitHub source shows `None` for its address and `Cannot check` for its update eligibility.
